...
void advancingFrontSurfaceReconstruction(std::vector<Point_3> points, std::vector<Facet> facets, Perimeter perimeter)
{
...
int main(int argc, char** argv)
{
  ...
  advancingFrontSurfaceReconstruction(points, facets, perimeter);
  return 0;
}